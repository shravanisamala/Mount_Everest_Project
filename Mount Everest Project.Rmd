...
MountEverestData$Decade <- ifelse(MountEverestData$YearOnly >= 1950, "1950", "1960")


MountEverestData$Decade <- " "
if (MountEverestData$YearOnly >= 1950 && MountEverestData$YearOnly < 1960) {
  MountEverestData$Decade == "1950"
} else if (MountEverestData$YearOnly >= 1960 && MountEverestData$YearOnly < 1970) {
  MountEverestData$Decade == "1960"
} else {
  MountEverestData$Decade == "1970"
}
